...
frappe.ui.form.on('Proform Invoice', {
	setup: function(frm) {
...
frappe.ui.form.on("Proform Invoice Item", {
...
erpnext.selling.SalesOrderController = class SalesOrderController extends erpnext.selling.SellingController {
	...
	make_purchase_order(){
		...
		if(!pending_items){
			frappe.throw({message: __("Purchase Order already created for all Proform Invoice items"), title: __("Note")});
		}
